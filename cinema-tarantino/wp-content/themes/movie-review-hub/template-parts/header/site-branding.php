    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-4 col-9 align-self-center text-right">
        <div class="book-tkt-btn">
          <?php if( get_theme_mod( 'movie_review_hub_more_videos_link' ) != '' || get_theme_mod( 'movie_review_hub_more_videos_button' ) != '') { ?>
            <a href="<?php echo esc_url( get_theme_mod( 'movie_review_hub_more_videos_link','' ) ); ?>" class="register-btn"><?php echo esc_html( get_theme_mod( 'movie_review_hub_more_videos_button','' ) ); ?></a>
          <?php } ?>
        </div>
      </div>
    </div>
