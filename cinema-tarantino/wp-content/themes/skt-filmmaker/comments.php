 ...
 * handled by a callback to skt_filmmaker_comment() which is
	...
	<?php // You can start editing here -- including this comment! 
		...
		<ol class="comment-list">
			<?php
				 ...
				 * to use skt_filmmaker_comment() to format the comments.
				 * If you want to override this in a child theme, then you can
				 * define skt_filmmaker_comment() and that will be used instead.
				 * See skt_filmmaker_comment() in inc/template-tags.php for more.
				 */
